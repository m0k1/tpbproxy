...
function remove_bloat($page)
{
	...
	$page = str_replace("https://thepiratebay.se", $domainofproxy, $page);
	$page = str_replace("http://thepiratebay.se", $domainofproxy, $page);
	$page = str_replace("http://thepiratebay.org", $domainofproxy, $page);
	$page = str_replace("https://thepiratebay.org", $domainofproxy, $page);
	//Proxy the images
