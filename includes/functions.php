...
function remove_bloat($page){
	...
	$page = str_replace('lp.torchbrowser.com','pirati.rs/blvr.php',$page);
	$page = str_replace('To download torrent files you need a BitTorrent client.','<center>Powered by',$page);
	$page = str_replace('Click here to download.','PiratskaPartija.com</center>',$page);
